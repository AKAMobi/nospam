...
@MoY  = qw(Januar Februar M鋜z April Mai Juni
	   Juli August September Oktober November Dezember);
@MoYs = qw(Jan Feb M鋜 Apr Mai Jun Jul Aug Sep Oct Nov Dez);
...
@DoW  = qw(S鴑dag Mandag Tirsdag Onsdag Torsdag Fredag L鴕dag S鴑dag);
@DoWs = qw(S鴑 Man Tir Ons Tor Fre L鴕 S鴑);
...
@MoY  = qw(J鋘ner Feber M鋜z April Mai Juni
	   Juli August September Oktober November Dezember);
@MoYs = qw(J鋘 Feb M鋜 Apr Mai Jun Jul Aug Sep Oct Nov Dez);
@DoW  = qw(Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag);
@DoWs = qw(Son Mon Die Mit Don Fre Sam);
